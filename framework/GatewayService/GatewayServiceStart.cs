...
{
    class GatewayServiceStart : BackgroundService
    {
        public readonly ILogger<GatewayServiceStart> _logger;

        public GatewayServiceStart(ILogger<GatewayServiceStart> logger)
        {
            _logger = logger;
